...
public final class IdAGUserCreateControllers
  extends IdAGDialogFactoryAbstract<Void, IdAGUserCreateController>
{
  /**
   * A factory of controllers.
   *
  ...
  public IdAGUserCreateControllers(
    final RPServiceDirectoryType inServices,
    final IdAGConfiguration inConfiguration,
    final IdAGStringsType inStrings)
  {
    super(
      IdAGUserCreateController.class,
      "/com/io7m/idstore_gui/admin/internal/userCreate.fxml",
      inServices,
      inConfiguration,
      inStrings
    );
  ...
  {
    return this.strings().format("userCreate.title");
  }

  @Override
  protected IdAGUserCreateController createController(
    final Void ignored,
    final Stage stage)
  {
    return new IdAGUserCreateController(stage);
  }
}
