...
public final class IdAGLoginControllers
  extends IdAGDialogFactoryAbstract<Void, IdAGLoginController>
{
  /**
   * A factory of dialogs.
   *
  ...
  {
    return this.strings().format("connect.connect");
  }

  @Override
  protected IdAGLoginController createController(
    final Void arguments,
    final Stage stage)
  {
    return new IdAGLoginController(
      this.services(),
      this.configuration(),
      stage
    );
