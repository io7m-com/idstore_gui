...
package com.io7m.idstore_gui.admin.internal.about;
...
public final class IdAGAboutControllers
  extends IdAGDialogFactoryAbstract<Void, IdAGAboutController>
{
  /**
   * A factory of dialogs.
   *
   ...
   * @param inMainServices  The main services
   */

  public IdAGAboutControllers(
    final RPServiceDirectoryType inMainServices,
    final IdAGConfiguration inConfiguration,
    final IdAGStringsType inStrings)
  {
    super(
      IdAGAboutController.class,
      "/com/io7m/idstore_gui/admin/internal/about.fxml",
      inMainServices,
      inConfiguration,
      inStrings);
  }
  ...
  @Override
  protected IdAGAboutController createController(
    final Void arguments,
    final Stage stage)
  {
    return new IdAGAboutController(this.strings());
  }
}
