...
public final class IdAGAdminDeleteConfirmControllers
  extends IdAGDialogFactoryAbstract<IdAdmin, IdAGAdminDeleteConfirmController>
{
  /**
   * A factory of controllers.
   *
  ...
  public IdAGAdminDeleteConfirmControllers(
    final RPServiceDirectoryType inServices,
    final IdAGConfiguration inConfiguration,
    final IdAGStringsType inStrings)
  {
    super(
      IdAGAdminDeleteConfirmController.class,
  ...
  {
    return this.strings().format("adminDelete.confirmTitle");
  }

  @Override
  protected IdAGAdminDeleteConfirmController createController(
    final IdAdmin admin,
    final Stage stage)
  {
    return new IdAGAdminDeleteConfirmController(admin, stage);
  }
}
