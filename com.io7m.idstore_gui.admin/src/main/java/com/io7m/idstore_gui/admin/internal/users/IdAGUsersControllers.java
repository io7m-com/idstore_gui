...
public final class IdAGUsersControllers
  extends IdAGViewControllerFactoryAbstract<Void, IdAGUsersController>
{
  /**
   * A factory of controllers.
   *
  ...
  public IdAGUsersControllers(
    final RPServiceDirectoryType inServices,
    final IdAGConfiguration inConfiguration,
    final IdAGStringsType inStrings)
  {
    super(
      IdAGUsersController.class,
      "/com/io7m/idstore_gui/admin/internal/tabUsers.fxml",
      inServices,
      inConfiguration,
      inStrings
    );
  ...
  @Override
  protected IdAGUsersController createController(
    final Void admin,
    final Stage stage)
  {
    return new IdAGUsersController(
      this.services(),
      this.configuration()
    );
  }
