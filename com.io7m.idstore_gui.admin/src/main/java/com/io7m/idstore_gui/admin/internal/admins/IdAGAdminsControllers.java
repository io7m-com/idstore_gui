...
public final class IdAGAdminsControllers
  extends IdAGViewControllerFactoryAbstract<Void, IdAGAdminsController>
{
  /**
   * A factory of controllers.
   *
  ...
  public IdAGAdminsControllers(
    final RPServiceDirectoryType inServices,
    final IdAGConfiguration inConfiguration,
    final IdAGStringsType inStrings)
  {
    super(
      IdAGAdminsController.class,
      "/com/io7m/idstore_gui/admin/internal/tabAdmins.fxml",
      inServices,
      inConfiguration,
      inStrings
    );
  ...
  @Override
  protected IdAGAdminsController createController(
    final Void admin,
    final Stage stage)
  {
    return new IdAGAdminsController(
      this.services(),
      this.configuration()
    );
  }
