...
public final class IdAGAdminEmailAddControllers
  extends IdAGDialogFactoryAbstract<Void, IdAGAdminEmailAddController>
{
  /**
   * A factory of controllers.
   *
  ...
  public IdAGAdminEmailAddControllers(
    final RPServiceDirectoryType inServices,
    final IdAGConfiguration inConfiguration,
    final IdAGStringsType inStrings)
  {
    super(
      IdAGAdminEmailAddController.class,
      "/com/io7m/idstore_gui/admin/internal/emailAdd.fxml",
      inServices,
      inConfiguration,
      inStrings
    );
  ...
  @Override
  protected IdAGAdminEmailAddController createController(
    final Void admin,
    final Stage stage)
  {
    return new IdAGAdminEmailAddController(
      this.configuration(),
      this.strings(),
      stage
    );
