...
package com.io7m.idstore_gui.admin;
...
public final class IdAGUI
{
  private final IdAGApplication app;

  private IdAGUI(
    final IdAGApplication inApp)
  {
  ...
  public static IdAGUI start(
    final IdAGConfiguration configuration)
    throws Exception
  {
    final var stage = new Stage();
    final var app = new IdAGApplication(configuration);
    app.start(stage);
    return new IdAGUI(app);
  }
}
