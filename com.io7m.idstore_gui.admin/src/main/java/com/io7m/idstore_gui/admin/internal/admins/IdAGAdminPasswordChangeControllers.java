...
public final class IdAGAdminPasswordChangeControllers
  extends IdAGDialogFactoryAbstract<Void, IdAGAdminPasswordChangeController>
{
  /**
   * A factory of controllers.
   *
  ...
  public IdAGAdminPasswordChangeControllers(
    final RPServiceDirectoryType inServices,
    final IdAGConfiguration inConfiguration,
    final IdAGStringsType inStrings)
  {
    super(
      IdAGAdminPasswordChangeController.class,
  ...
  @Override
  protected IdAGAdminPasswordChangeController createController(
    final Void admin,
    final Stage stage)
  {
    return new IdAGAdminPasswordChangeController(
      this.configuration(),
      this.strings(),
      stage
    );
