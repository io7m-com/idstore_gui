...
public final class IdTestDirectories
{
  private static final Logger LOGGER =
    LoggerFactory.getLogger(IdTestDirectories.class);

  private IdTestDirectories()
  {
    ...
    throws IOException
  {
    ...
    final var path = Path.of(property).resolve("idstore");
  ...
  public static Path resourceOf(
    ...
    throws IOException
  {
    final var internal = String.format("/com/io7m/idstore/gui/tests/%s", name);
