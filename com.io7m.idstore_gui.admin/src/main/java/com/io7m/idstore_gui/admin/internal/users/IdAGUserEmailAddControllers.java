...
public final class IdAGUserEmailAddControllers
  extends IdAGDialogFactoryAbstract<Void, IdAGUserEmailAddController>
{
  /**
   * A factory of controllers.
   *
  ...
  {
    return this.strings().format("users.email");
  }

  @Override
  protected IdAGUserEmailAddController createController(
    final Void admin,
    final Stage stage)
  {
    return new IdAGUserEmailAddController(
      this.configuration(),
      this.strings(),
      stage
    );
